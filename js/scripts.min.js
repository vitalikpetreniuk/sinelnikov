...
$(function() {
    ...
    $(window).on('load resize', function () {
       ...
       $('.faq-item').each(function () {
        ...
        if (window.matchMedia('(max-width: 1019px)').matches) {
            if(testNum === 1){
                $('.list-1.videos').addClass('owl-carousel').owlCarousel({
                    items: 1,
                    margin: 20
                });
                $('.list-1.audios').addClass('owl-carousel').owlCarousel({
                    responsive:{
                        0:{
                            items: 1,
                            margin: 20
            ...
            if(testNum === 0){
                $('.list-1').removeClass('owl-carousel').owlCarousel('destroy');
                testNum = 1;
            }
        }
        if (window.matchMedia('(max-width: 767px)').matches){
            $('.table-product-category').each(function () {
                $(this).prependTo($(this).closest('.table-col'));
            });
        } else{
            $('.table-product-category').each(function () {
                $(this).prependTo($(this).closest('.table-col').find('.table-product-block'));
            });
        }
    ...
    $('.menu-xs-toggle').on('click', function () {
       $(this).parent().toggleClass('open').siblings().removeClass('open');
    });

    $('.user-menu-toggle').on('click', function () {
       $(this).toggleClass('active').parent().siblings('.add-menu').slideToggle('fast');
    });
